...
<body id="container-page-registration">
    ...
    <section id="form-registration" style="background-color: #FDFD96;">
        <div class="container">
            <div class="page-header" style=" color:#009999">
              <h1>REGISTRO <small class="tittles-pages-logo">E-COMMERCE MINIMARKET DON LUCHO</small></h1>
            </div>
            <p class="lead text-center">
              Registrese para tener acceso a los productos que disponemos y a la vez realizar su compra y pedido desde casa.
            </p>
            <div class="row">
                
                <div class="col-sm-7">
                    <div id="container-form" style="background-color: #F4F4F4; ">
                       <p class="text-center lead" style="font-size:40px">Registro de Clientes</p>
                       <br><br>
                ...
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/registro.jpeg" alt="store" class="img-responsive">
                    </figure>
                </div>
            </div>
        </div>
