...
<?php if(strlen($_SESSION['login']))
    {   ?>	
				...
				<?php } ?>
					...
					<li><a href="my-account.php"><i class="icon fa fa-user"></i>Inicio</a></li>
					<li><a href="productos.php"><i class="icon fa fa-heart"></i>Productos</a></li>
					 
					<li><a href="my-cart.php"><i class="icon fa fa-shopping-cart"></i>Registro</a></li>
...
<div class="cnt-block">
				...
				<ul class="list-unstyled list-inline">
					<li class="dropdown dropdown-small">
						<a href="track-orders.php" class="dropdown-toggle" ><span class="key" style=" color:#003311">Cerrar sesión</b></a>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" style=" color:#4d94ff"href="#">MINIMARKET DON LUCHO</a>
    </div>
