                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" type="text" name="Cci" value="<?php echo $bankD['NumeroCuenta']; ?>" maxlength="50" required="">
                                </div>
                            </div>-->
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                ...
                <div class="container-fluid">
                    <div class="row">
                       ...
                       <!-- <div class="col-xs-12 col-sm-6">
                            <div class="form-group label-floating">
                                <label class="control-label">CCI</label>
                                <input class="form-control" type="text" name="Cci" maxlength="50" required="">
                            </div> 
                        </div>-->
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group label-floating">
