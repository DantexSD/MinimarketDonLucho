...
<nav id="navbar-auto-hidden">
        ...
        <div class="row hidden-xs">
            ...
            <div class="col-xs-4">
                <p class="text-navbar tittles-pages-logo">Minimarket Don Lucho</p>
            </div>
    ...
    <div class="modal fade modal-login" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" style="background-color: #000000">
      <div class="modal-dialog modal-sm">
          <div class="modal-content" id="modal-form-login" style="padding: 15px;">
            ...
            <form action="process/login.php" method="post" role="form" class="FormCatElec" data-form="login" >
                ...
                <div class="radio">
                  <label>
                      <input type="radio" name="optionsRadios" value="option1" checked="" style="color:black;">
                      Usuario
                  </label>
               </div>
               ...
               <div class="radio">
                ...
                <div class="modal-footer">
                  <button type="submit" class="btn btn-primary btn-raised btn-sm" style="background-color: #FF8000">Iniciar sesión</button>
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo">Don Lucho</h3>
